...
interface SidebarProps { view:NavigationView; documents:Document[]; active:Document|null; draft:string; patches:Patch[]; onOpen:(id:string)=>void; onSelect:(start:number,end:number)=>void }
...
function FilesView(props: SidebarProps) {
  return <><SectionLabel>Workspace</SectionLabel>
