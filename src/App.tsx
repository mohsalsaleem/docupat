    ...
    <main className="grid min-h-0 flex-1 grid-cols-[44px_250px_minmax(0,1fr)]">
      ...
      <section className="flex min-w-0 flex-col overflow-hidden">
        ...
        <div className="relative min-h-0 flex-1 overflow-hidden">
          ...
          {!app.preview ? <PatchComposer selection={app.selection} instruction={app.instruction} proposal={app.proposal} busy={app.busy} message={app.message} onInstruction={app.setInstruction} onPropose={app.propose} onApply={app.apply} onReject={app.reject} /> : null}
        </div>
      </section>
    </main>
